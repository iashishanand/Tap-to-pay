...
void setup() {
  ...
  mfrc522.PCD_Init();
  Serial.println();
  Serial.println("##################### WELCOME TO TAP-TO-PAY RECHARGE BOOTH #####################");
  Serial.println();
  Serial.println("Scan the ID Card to do recharge : " + String((char*)blockData));
  //-----------------------------------------
}
...
void loop() {
  ...
  Serial.print("\n");
  Serial.println("Doing recharge...");
  WriteDataToBlock(blockNum, blockData);
  //------------------------------------------------------------------------------
  /* Read data from the same block */
  Serial.print("\n");
  Serial.println("Checking new balance...");
